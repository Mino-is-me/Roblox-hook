...
## 🎮 유저 정보
- **이름**: Pigbank1 (@Pigbank1)
- **유저 ID**: 181223950
- **가입일**: 2016-11-14T02:58:59.243Z
- **다운로드 시간**: 2025-09-15 16:49:20

## 📐 모델 정보
- **카메라 위치**: {'x': -2.25183, 'y': 104.547, 'z': -4.59824}
- **카메라 FOV**: 70.0
- **바운딩 박스**: {'x': -1.88371, 'y': 99.9408, 'z': -0.838837} ~ {'x': 1.9614, 'y': 104.607, 'z': 0.587164}
