...
## 🎮 유저 정보
- **이름**: Sleepark (@Sleepark)
- **유저 ID**: 174813660
- **가입일**: 2016-10-26T11:40:35.077Z
- **다운로드 시간**: 2025-09-17 11:57:50

## 📐 모델 정보
- **카메라 위치**: {'x': -2.50759, 'y': 105.419, 'z': -5.31971}
- **카메라 FOV**: 70.0
- **바운딩 박스**: {'x': -1.78447, 'y': 100.01, 'z': -1.24351} ~ {'x': 1.7847, 'y': 105.812, 'z': 0.733855}
