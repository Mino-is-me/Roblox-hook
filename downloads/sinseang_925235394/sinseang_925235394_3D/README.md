...
## 🎮 유저 정보
- **이름**: sinsaeng (@sinseang)
- **유저 ID**: 925235394
- **가입일**: 2019-01-09T10:00:51.287Z
- **다운로드 시간**: 2025-09-11 16:54:12

## 📐 모델 정보
- **카메라 위치**: {'x': -2.05841, 'y': 104.321, 'z': -4.23659}
- **카메라 FOV**: 70.0
- **바운딩 박스**: {'x': -1.58106, 'y': 100.01, 'z': -1.01112} ~ {'x': 1.57072, 'y': 104.526, 'z': 0.831825}
